  ...
  //       final distance = data['features'][0]['properties']['segments'][0]['distance'] / 1000; // Convert to km
  //       final duration = data['features'][0]['properties']['segments'][0]['duration'] / 60; // Convert to minutes
